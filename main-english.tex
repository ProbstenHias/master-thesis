...
The main challenge is to find a decomposition so that, on the one hand, all functionalities that should be interchangeable are encompassed in an extra plugin,
...
Datasets of different \emph{sizes} have been generated, spanning from a modest 10 data points to a substantial 100,000 data points.
...
To adhere to \gls{qhana}'s data standards, the generated datasets fullfill the following criteria:
\begin{itemize}
...
% TODO add example datasets here
...
\begin{figure}
  ...
  \caption[Total times to get loss value compared including cached appraoch]{Comparison of the total time it takes to get the loss value across different implementations, including a cached version of the first plugin-based implementation approach.}
