...
\begin{itemize}
  ...
  \item currently creating a method to get the plugin name from the plugin url
  \item currently creating a method to get the plugin metadata from the plugin url
\end{itemize}
