...
The next step was Analyzing the inherent modularity in optimization processes and identifying distinct tasks or functionalities that could be encapsulated into plugins.
...
For instance, a plugin could invoke the microfrontend of another plugin, or it could call a specific endpoint of another plugin.
