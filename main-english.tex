...
\subsubsection{Objective Function Plugin Interfaces}
...
\subsubsection{Minimizer Plugin Interfaces}
...
\subsubsection{Coordinator Plugin Interfaces}
...
here we define the architecture of the system
in which plugins we split the system
(coodinator, objective function, minimizer)
...
how they get metadata
what data formats they send
we can add the numpy array format in marschmellow
we can say we use the db to share data across interaction endpoints
